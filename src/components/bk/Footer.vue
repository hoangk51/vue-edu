                      ...
                      <div class="swiper-slide">
                        <div class="posts-single media">
                          ...
                          <div class="post-content media-body">
                            <div class="post-title">
                              <h5>
                                <a href>Aypi non habent claritatem insitam</a>
                              </h5>
                            </div>
                        ...
                        <div class="posts-single media">
                          ...
                          <div class="post-content media-body">
                            <div class="post-title">
                              <h5>
                                <a href>Bypi non habent claritatem insitam</a>
                              </h5>
                            </div>
                            <div class="post-date">09 Aug</div>
                          </div>
                      ...
                      <div class="swiper-slide">
                        <div class="posts-single media">
                          ...
                          <div class="post-content media-body">
                            <div class="post-title">
                              <h5>
                                <a href>Cabent claritatem insitam</a>
                              </h5>
                            </div>
                        ...
                        <div class="posts-single media">
                          ...
                          <div class="post-content media-body">
                            <div class="post-title">
                              <h5>
                                <a href>Cypi non habent claritatem insitam</a>
                              </h5>
                            </div>
                            <div class="post-date">09 Aug</div>
                          </div>
        ...
        <div class="row align-items-center">
          <div class="col-12 col-sm-12 col-md-12 col-lg-6">
            <p class="copyright-text" id="copyright">
              Copyright © 2018
              <a href="#" rel="nofollow">Ororus Themes</a>. All Right Reserved.
            </p>
          </div>
          <div class="col-12 col-sm-12 col-md-12 col-lg-6">
            <div class="footer-payment">
              <ul>
                <li>
                  <a href="#">
                    <img src="images/payment-1.jpg" alt="Payment Icons" />
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="images/payment-2.jpg" alt="Payment Icons" />
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="images/payment-3.jpg" alt="Payment Icons" />
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="images/payment-4.jpg" alt="Payment Icons" />
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="images/payment-5.jpg" alt="Payment Icons" />
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="images/payment-6.jpg" alt="Payment Icons" />
                  </a>
                </li>
              </ul>
            </div>
