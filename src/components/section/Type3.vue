            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-sm-40">
                        ...
                        <!-- Post Title End -->
                        <div class="single-cat-pro-active owl-carousel owl-loaded owl-drag">

                            <!-- Triple Product End -->

                            <!-- Triple Product End -->
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 736px;"><div class="owl-item active" style="width: 367.99px;"><div class="triple-product">
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="pro-content">
                                        <div class="pro-info">
                                            ...
                                            <p><span class="price">$17.35</span></p>
                                        </div>
                                    </div>
                                    <!-- Product Content End -->
                                </div>
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="pro-content">
                                        <div class="pro-info">
                                            ...
                                            <p><span class="price">$22.45</span></p>
                                        </div>
                                    </div>
                                    <!-- Product Content End -->
                                </div>
                                <!-- Single Product End -->
                            </div></div><div class="owl-item" style="width: 367.99px;"><div class="triple-product">
                                <!-- Single Product Start -->
                                <div class="single-product">
                                    <!-- Product Image Start -->
                                    <div class="pro-img">
                        ...
                        <!-- Categorie Product Activation End -->
                    </div>
