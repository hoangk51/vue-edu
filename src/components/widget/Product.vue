    ...
    <div class="post-title">
      <h2>
        <i class="ion-ribbon-b" aria-hidden="true"></i>new products
      </h2>
    </div>
    <!-- Post Title End -->
    <div class="single-cat-pro-active owl-carousel owl-loaded owl-drag">
      ...
      <div class="owl-stage-outer">
        <div
          class="owl-stage"
          style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 736px;"
        >
          <div class="owl-item active" style="width: 367.99px;">
            <div class="triple-product">
              ...
              <div class="single-product">
                ...
                <div class="pro-content">
                  <div class="pro-info">
                    <h4>
                      <a href="product.html">hot summer dress</a>
                    </h4>
                    <div class="product-rating">
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
          ...
          <div class="owl-item" style="width: 367.99px;">
            <div class="triple-product">
              <!-- Single Product Start -->
              <div class="single-product">
                <!-- Product Image Start -->
